...
AudioAnalyzeToneDetect   startStop;
...
AudioConnection patchCord09(audioIn, 0, startStop, 0);
...
const float row_threshold = 0.1;
const float column_threshold = 0.1;
